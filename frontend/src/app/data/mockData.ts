...
export const MOCK_BOOTHS: Booth[] = [
  {
    ...
    brochures: [
      { name: 'Product Catalog 2026', url: '#' },
      { name: 'Case Studies', url: '#' },
    ],
    representatives: [
      { name: 'Lisa Anderson', title: 'VP of Sales' },
      { name: 'Tom Bradley', title: 'Solutions Architect' },
    ],
    isLive: true,
    visitCount: 234,
  },
  {
    ...
    representatives: [
      { name: 'Sarah Kim', title: 'Account Executive' },
    ],
    isLive: true,
    visitCount: 156,
  },
  {
    ...
    brochures: [
      { name: 'Infrastructure Solutions', url: '#' },
    ],
    representatives: [
      { name: 'David Park', title: 'Technical Lead' },
      { name: 'Nina Roberts', title: 'Customer Success' },
    ],
    isLive: false,
    visitCount: 89,
  },
  {
    ...
    brochures: [
      { name: 'Security Assessment', url: '#' },
    ],
    representatives: [
      { name: 'Alex Morgan', title: 'Security Consultant' },
    ],
    isLive: true,
    visitCount: 67,
  },
  {
    ...
    representatives: [
      { name: 'Jennifer Lee', title: 'Product Manager' },
    ],
    isLive: false,
    visitCount: 45,
  },
